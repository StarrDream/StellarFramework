...
| `FlowKit_Playable.unity` | JSON Graph 编译、Delay 调度与 Complete 生命周期 | 可直接运行 |
...
- `FlowKit_Playable.unity` 依赖 FlowKit.Core + UnityIntegration，不需要 UniTask、资源、Addressables 或热更前置
