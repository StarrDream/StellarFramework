...
| `FlowKit_Playable.unity` | 4 人消防演练：Operation/Signal/State 双向通信、并行、失败、取消、超时与汇合 | 可直接运行 |
...
11. `FlowKit_Playable.unity`
12. `BindableKit_Playable.unity`
13. `EventKit_Playable.unity`
14. `LogKit_Playable.unity`
15. `SingletonKit_Playable.unity`
16. `AudioKit_Playable.unity`
17. `ConfigKit_Playable.unity`
18. `SettingsKit_Playable.unity`
19. `FSMKit_Playable.unity`
20. `PoolKit_Playable.unity`
21. `HttpKit_Playable.unity`
...
- `FlowKit_Playable.unity` 依赖 FlowKit.Core + UnityIntegration，不需要 UniTask、资源、Addressables 或热更前置；场景直接使用消防演练 Graph 演示双向业务闭环
