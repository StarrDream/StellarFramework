...
- PathKit Grid Adapter Benchmark（Unity 2022.3.62f3c1，Editor Test Runner）：256×256 FourWay A* 1.312 ms / 510 expanded；EightWay Dijkstra 244.800 ms / 65,535 expanded；路线 Cost=510、PathLength=511。数值仅用于本机趋势，不构成跨平台性能承诺。
