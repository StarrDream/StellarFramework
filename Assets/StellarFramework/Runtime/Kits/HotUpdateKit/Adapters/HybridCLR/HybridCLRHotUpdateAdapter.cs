...
namespace StellarFramework.HotUpdate
{
    ...
    // Contracts and the HotUpdate.Core facade moved to HotUpdateContracts.cs.
    // They remain here as disabled source only to preserve the original history during this split.
#if false
