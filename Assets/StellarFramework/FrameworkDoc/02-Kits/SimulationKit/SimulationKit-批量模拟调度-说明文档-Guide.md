...
`StellarFramework-SimulationKit.unitypackage` 只包含 SimulationKit Runtime 和 asmdef；不包含 UnityEngine 引用、其他 Kit、UPM、Samples、Tests 或 Verification。当前不再提供独立 SimulationKit Sample 包。
