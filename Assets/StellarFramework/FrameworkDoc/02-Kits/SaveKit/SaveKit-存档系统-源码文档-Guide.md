...
V1.1 可进一步改为 Temp Stream Direct Write、Directory Seek 回填和 BoundedReadStream。
...
V1.1 后续方向是 Temp Stream Direct Write、BoundedReadStream、流式 Checksum 和目录回填。

更后续可研究压缩、Cloud Storage、分页 Save Compare 和 Create Modified Copy。
